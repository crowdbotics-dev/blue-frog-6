"""
Django settings for blue_frog_6 project.
...
WSGI_APPLICATION = 'blue_frog_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_frog_6 API",
    "DESCRIPTION": "API documentation for blue_frog_6 App",
    "VERSION": "v1",
}
